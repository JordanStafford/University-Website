...
<head>
  ...
  <link rel="stylesheet" href="p_two.css" />
...
<body>
  ...
  <p style="text-align: left;">
    Our second choice of drinks machine is one of the premium selections we have to offer
  </p>
  <?php
  require_once 'config.php';

   $sql = "SELECT * FROM machines LIMIT 1 OFFSET 1";
